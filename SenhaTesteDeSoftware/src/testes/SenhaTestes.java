...
public class SenhaTestes {
	...
	/*
	 * @Test (expected=PosicaoInvalidaException.class) public void
	 * adicionarPinoTestePosicaoNegativaCorVermelho() throws
	 * CorInvalidaException, PosicaoInvalidaException {
	 * 
	 * senha.setPinosInseridos(-1); senha.adicionarPino("vermelho");
	...
	@Test
	public void adicionarPinoTestePosicaoZeroCorAzul()
	...
	@Test
	public void adicionarPinoTestePosicao3CorRoxo()
	...
	@Test
	public void getPinoTestePosicaoEntreZeroETres()
	...
	@Test
	public void ehSenhaValidaTesteArrayComTodosPinos()
			throws PosicaoInvalidaException {
